...
GFX_ARR_BEGIN(obj_s_palm3_leafT_mat_model)
...
GFX_ARR_BEGIN(obj_s_palm3_leafT_gfx_model)
...
GFX_ARR_BEGIN(obj_s_palm3_trunkT_mat_model)
...
GFX_ARR_BEGIN(obj_s_palm3_trunkT_gfx_model)
