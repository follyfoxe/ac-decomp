...
GFX_ARR_BEGIN(obj_w_tree4_leafT_mat_model)
...
GFX_ARR_BEGIN(obj_w_gold_tree4_leafT_mat_model)
    gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
    gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 64, obj_w_tree_leaf_tex),
...
GFX_ARR_BEGIN(obj_w_tree4_leafT_gfx_model)
...
GFX_ARR_BEGIN(obj_w_tree4_trunkT_mat_model)
    gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
GFX_ARR_BEGIN(obj_w_gold_tree4_trunkT_mat_model)
    gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
    gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 64, obj_w_tree_trunk_tex),
    gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 8, GX_CLAMP, GX_CLAMP, 0, 0),
    gsSPEndDisplayList(),
...
GFX_ARR_BEGIN(obj_w_tree4_trunkT_gfx_model)
