...
GFX_ARR_BEGIN(obj_s_tree5_leafT_mat_model)
...
GFX_ARR_BEGIN(obj_s_gold_tree5_leafT_mat_model)
    gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
    gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 64, obj_s_tree3_leaf_tex),
...
GFX_ARR_BEGIN(obj_s_tree5_leafT_gfx_model)
...
GFX_ARR_BEGIN(obj_s_tree5_trunkT_mat_model)
    gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
GFX_ARR_BEGIN(obj_s_gold_tree5_trunkT_mat_model)
    gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
    gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 64, obj_s_tree4_trunk_tex),
    gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 8, GX_CLAMP, GX_CLAMP, 0, 0),
    gsSPEndDisplayList(),
...
GFX_ARR_BEGIN(obj_s_tree5_trunkT_gfx_model)
