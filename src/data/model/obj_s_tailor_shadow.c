...
u8 obj_s_tailor_shadow_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/obj_s_tailor_shadow_tex.inc"
};
...
GFX_ARR_BEGIN(obj_s_tailor_shadowT_model)
    ...
    gsDPSetTextureImage_Dolphin(G_IM_FMT_I, G_IM_SIZ_4b, 16, 16, obj_s_tailor_shadow_tex),
