...
GFX_ARR_BEGIN(int_nog_balloon2_weight_model)
...
GFX_ARR_BEGIN(int_nog_balloon2_a_model)
    gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
GFX_ARR_BEGIN(int_nog_balloon2_b_model)
    gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
    gsDPSetCombineLERP(PRIMITIVE, 0, SHADE, 0, TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
    gsDPSetPrimColor(0, 255, 255, 255, 255, 100),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
...
GFX_ARR_BEGIN(int_nog_balloon2_c_model)
    gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
    gsDPSetCombineLERP(PRIMITIVE, 0, SHADE, 0, TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
    gsDPSetPrimColor(0, 255, 255, 255, 255, 100),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
...
GFX_ARR_BEGIN(int_nog_balloon2_head_model)
