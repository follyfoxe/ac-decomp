...
GFX_ARR_BEGIN(obj_yubinkyoku_shine_modelT)
    ...
    gsDPSetTextureImage(G_IM_FMT_I, G_IM_SIZ_16b, 1, rom_yubinkyoku_mado_tex),
    ...
    gsSPVertex(obj_yubinkyoku_shine_v, 7, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsSP2Triangles(4, 5, 6, 0, 4, 6, 0, 0),
    gsDPPipeSync(),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_XLU_DECAL2),
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_I, G_IM_SIZ_16b, 1, rom_yubinkyoku_waku_tex),
    ...
    gsSPVertex(&obj_yubinkyoku_shine_v[7], 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
