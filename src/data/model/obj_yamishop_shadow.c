...
u8 obj_yamishop_shadow_tex[] ATTRIBUTE_ALIGN(32) = {
#include "assets/obj_yamishop_shadow_tex.inc"
};

Vtx obj_yamishop_shadow_v[] = {
...
GFX_ARR_BEGIN(obj_yamishop_shadowT_model)
    ...
    gsDPSetTextureImage_Dolphin(G_IM_FMT_I, G_IM_SIZ_4b, 32, 32, obj_yamishop_shadow_tex),
