...
GFX_ARR_BEGIN(obj_melody_shadowT_mat_model)
...
GFX_ARR_BEGIN(obj_melody_shadowT_gfx_model) gsSPNTrianglesInit_5b(2, 0, 1, 2, 0, 2, 3, 0, 0, 0), gsSPEndDisplayList() GFX_ARR_END
