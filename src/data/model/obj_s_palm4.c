...
GFX_ARR_BEGIN(obj_s_palm4_leafT_mat_model)
...
GFX_ARR_BEGIN(obj_s_palm4_leafT_gfx_model)
...
GFX_ARR_BEGIN(obj_s_palm4_trunkT_mat_model)
...
GFX_ARR_BEGIN(obj_s_palm4_trunkT_gfx_model)
