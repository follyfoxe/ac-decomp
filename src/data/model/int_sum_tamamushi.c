...
GFX_ARR_BEGIN(int_sum_tamamushi_side_model)
...
GFX_ARR_BEGIN(int_sum_tamamushi_komado_model)
...
GFX_ARR_BEGIN(int_sum_tamamushi_glass_model)
    gsSPTexture(4000, 4000, 0, G_TX_RENDERTILE, G_ON),
    gsDPSetCombineLERP(TEXEL0, 0, PRIMITIVE, 0, TEXEL0, 0, PRIMITIVE, 0, COMBINED, 0, SHADE, 0, 0, 0, 0, COMBINED),
...
GFX_ARR_BEGIN(int_sum_tamamushi_base_model)
    gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
GFX_ARR_BEGIN(int_sum_tamamushi_body_model)
    gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
    gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    gsDPLoadTLUT_Dolphin(15, 16, 1, int_sum_tamamushi_pal),
