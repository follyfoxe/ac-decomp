...
GFX_ARR_BEGIN(obj_w_cedar5_leafT_mat_model)
...
GFX_ARR_BEGIN(obj_w_cedar5_leafT_gfx_model)
...
GFX_ARR_BEGIN(obj_w_cedar5_trunkT_mat_model)
    gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
GFX_ARR_BEGIN(obj_w_cedar5_trunkT_gfx_model)
