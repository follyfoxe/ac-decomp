...
u8 ef_kantanhu01_0[] ATTRIBUTE_ALIGN(32) = {
#include "assets/ef_kantanhu01_0.inc"
};

Vtx ef_kantanhu01_00_v[] = {
...
GFX_ARR_BEGIN(ef_kantanhu01_00_modelT)
    ...
    gsDPSetTextureImage_Dolphin(G_IM_FMT_IA, G_IM_SIZ_8b, 32, 32, ef_kantanhu01_0),
