...
GFX_ARR_BEGIN(onp_win_ga3_model)
...
GFX_ARR_BEGIN(onp_win_wakuT_model)
...
GFX_ARR_BEGIN(onp_win_meT_model)
...
GFX_ARR_BEGIN(onp_win_ga1T_model)
...
GFX_ARR_BEGIN(onp_win_ga2T_model)
...
GFX_ARR_BEGIN(onp_win_hanaT_model)
...
GFX_ARR_BEGIN(onp_win_senT_model)
...
GFX_ARR_BEGIN(onp_win_waku2T_model)
...
GFX_ARR_BEGIN(onp_win_waku3T_model)
...
GFX_ARR_BEGIN(onp_win_shiroT_model)
...
GFX_ARR_BEGIN(onp_win_owariT_model)
...
GFX_ARR_BEGIN(onp_win_waku5T_model)
...
GFX_ARR_BEGIN(onp_win_waku6T_model)
...
static GFX_ARR_BEGIN(onp_win_rmoji_model)
...
GFX_ARR_BEGIN(onp_win_rbuttonT_model)
    gsDPSetPrimColor(0, 255, 255, 255, 255, 255),
...
GFX_ARR_BEGIN(onp_win_leafT_model)
...
GFX_ARR_BEGIN(onp_win_cardeT_model)
    gsDPSetPrimColor(0, 255, 255, 255, 255, 255),
