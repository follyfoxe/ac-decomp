...
GFX_ARR_BEGIN(obj_f_tree5_leafT_mat_model)
...
GFX_ARR_BEGIN(obj_f_gold_tree5_leafT_mat_model)
    gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
    gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 64, obj_f_tree_leaf_tex),
...
GFX_ARR_BEGIN(obj_f_tree5_leafT_gfx_model)
...
GFX_ARR_BEGIN(obj_f_tree5_trunkT_mat_model)
    gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
...
GFX_ARR_BEGIN(obj_f_gold_tree5_trunkT_mat_model)
    gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
    gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 64, obj_f_tree_trunk_tex),
...
GFX_ARR_BEGIN(obj_f_tree5_trunkT_gfx_model)
